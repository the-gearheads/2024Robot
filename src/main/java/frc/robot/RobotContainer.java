...
public class RobotContainer {
  ...
  public void updateControllers() {
    ...
    Controllers.driverController.getAimAndFeedBtn().whileTrue(new WaitUntilCommand(() -> {return swerve.atYaw(ShooterCalculations.getYaw(swerve).getRadians(), NOTE_FEEDING_YAW_TOLERANCE);}).andThen(new ShootFeederNote(arm, feeder, shooter, swerve::getPose)));
