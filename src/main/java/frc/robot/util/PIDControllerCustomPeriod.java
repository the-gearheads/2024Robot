...
public class PIDControllerCustomPeriod implements Sendable, AutoCloseable {
   ...
   */
  public PIDControllerCustomPeriod(double kp, double ki, double kd) {
    this(kp, ki, kd, 0.02);
  }
  ...
  public PIDControllerCustomPeriod(double kp, double ki, double kd, double period) {
    m_kp = kp;
    m_ki = ki;
    m_kd = kd;
