...
public class SwerveSetpointGenerator {
  ...
  private boolean epsilonEquals(double numA, double numB) {
    return MathUtil.isNear(numA, numB, 1e-6);
  }

  private boolean epsilonEquals(ChassisSpeeds speedsA, ChassisSpeeds speedsB) {
    return epsilonEquals(speedsA.vxMetersPerSecond, speedsB.vxMetersPerSecond) &&
           epsilonEquals(speedsA.vyMetersPerSecond, speedsB.vyMetersPerSecond) &&
           epsilonEquals(speedsA.omegaRadiansPerSecond, speedsB.omegaRadiansPerSecond);
  }
