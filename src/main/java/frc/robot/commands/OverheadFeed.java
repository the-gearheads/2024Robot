...
public class OverheadFeed extends Command {
  Arm arm;
  Feeder feeder;
  Shooter shooter;
  Swerve swerve;
  ...
  public OverheadFeed(Arm arm, Feeder feeder, Shooter shooter, Swerve swerve, boolean waitForYaw) {
    this.arm = arm;
    this.feeder = feeder;
  ...
  public void execute() {
    ...
    Logger.recordOutput("OverheadFeed/AtYaw", atYawIfWaiting);
    Logger.recordOutput("OverheadFeed/WaitForYaw", waitForYaw);
