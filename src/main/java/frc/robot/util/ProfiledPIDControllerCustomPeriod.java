 ...
 */
public class ProfiledPIDControllerCustomPeriod implements Sendable {
  private static int instances;

  private PIDControllerCustomPeriod m_controller;
   ...
   */
  public ProfiledPIDControllerCustomPeriod(
  ...
  public ProfiledPIDControllerCustomPeriod(
    ...
    m_controller = new PIDControllerCustomPeriod(Kp, Ki, Kd, period);
